...
import (
	...
	jsn "github.com/anaetrezve/url-shortener-golang/serializer/json"
	msgp "github.com/anaetrezve/url-shortener-golang/serializer/msgpack"
...
func (h *handler) serializer(contentType string) shortener.RedirectSerializer {
	if contentType == "applicaiton/x-msgpack" {
		return &msgp.Redirect{}
	}
	return &jsn.Redirect{}
}
